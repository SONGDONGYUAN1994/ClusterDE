...
dlpfc_twodomain_sce$array_row <- dlpfc_twodomain@meta.data$row
dlpfc_twodomain_sce$array_col <- dlpfc_twodomain@meta.data$col
...
We use spatial coordinates as covariates to generate synthetic null data, then apply the same BayesSpace clustering method as target data. This may take a few minutes to run.
```{r}
set.seed(seed)
...
null_obj_sce$array_row <- dlpfc_twodomain@meta.data$row
null_obj_sce$array_col <- dlpfc_twodomain@meta.data$col
